...
const _instance_of_Documentation_017b35893bb2b525d9dc = db.assignTag('017b35893bb2b525d9dc');
const _instance_of_Documentation_017b35893fcf512966aa = db.assignTag('017b35893fcf512966aa');
const _instance_of_Documentation_017b35893fd03e9b2283 = db.assignTag('017b35893fd03e9b2283');
const _instance_of_Documentation_017b358942f4b3302140 = db.assignTag('017b358942f4b3302140');
...
db.newInstance(_instance_of_Runnable_Output____s1_localeCompare$_40_$s2$_41_$_01717c85b82ead71668c)
    ...
    .done();
// :_instance_of_Documentation_017b35893bb2b525d9dc
db.newInstance(_instance_of_Documentation_017b35893bb2b525d9dc)
    .setModelTag(_Documentation_01703376c4a81c0e9d90) // tag of the model
    // Tag of goos
    .addToGroupOfObjects(_instance_of_Coded_Function_model____Compare_Strings_01717c85b2ba886e5047)
    .setNameOrProperties({
        [_Documentation_description_01703376c4a81c0e9d92]:'Returns a number indicating whether the reference string s2 comes before, after, or is equivalent to s1 string in sort order',
        [_Documentation_summary_01703376c4a81c0e9d91]:'Compare a string with another one.',
        'v'                                     :1
    })
    .done();
// :_instance_of_Documentation_017b35893fcf512966aa
db.newInstance(_instance_of_Documentation_017b35893fcf512966aa)
    .setModelTag(_Documentation_01703376c4a81c0e9d90) // tag of the model
    // Tag of goos
    .addToGroupOfObjects(_instance_of_Coded_Function_model____Compare_Strings_01717c85b2ba886e5047)
    .setNameOrProperties({
    ...
    .done();
// :_instance_of_Documentation_017b35893fd03e9b2283
db.newInstance(_instance_of_Documentation_017b35893fd03e9b2283)
    .setModelTag(_Documentation_01703376c4a81c0e9d90) // tag of the model
    // Tag of goos
    .addToGroupOfObjects(_instance_of_Coded_Function_model____Compare_Strings_01717c85b2ba886e5047)
    .setNameOrProperties({
    ...
    .done();
// :_instance_of_Documentation_017b358942f4b3302140
db.newInstance(_instance_of_Documentation_017b358942f4b3302140)
    .setModelTag(_Documentation_01703376c4a81c0e9d90) // tag of the model
    // Tag of goos
    .addToGroupOfObjects(_instance_of_Coded_Function_model____Compare_Strings_01717c85b2ba886e5047)
    .setNameOrProperties({
        [_Documentation_description_01703376c4a81c0e9d92]:'-1 if s1 < s2, 0 if s1 == s2, 1 if s1 > s2.',
        'v'                                     :1
    })
    .done();
...
db.assign(_instance_of_Documentation_017b35893bb2b525d9dc   , _Documentation_documentation_01703376c4a81c0e9d93 , _instance_of_Coded_Function_model____Compare_Strings_01717c85b2ba886e5047);
db.assign(_instance_of_Documentation_017b35893fcf512966aa   , _Documentation_documentation_01703376c4a81c0e9d93 , _instance_of_Runnable_Input____s1_01717c85b4b1db6dd737);
db.assign(_instance_of_Documentation_017b35893fd03e9b2283   , _Documentation_documentation_01703376c4a81c0e9d93 , _instance_of_Runnable_Input____s2_01717c85b62789063178);
db.assign(_instance_of_Documentation_017b358942f4b3302140   , _Documentation_documentation_01703376c4a81c0e9d93 , _instance_of_Runnable_Output____s1_localeCompare$_40_$s2$_41_$_01717c85b82ead71668c);
...
db.assign(_instance_of_Coded_Function_model____Compare_Strings_01717c85b2ba886e5047, _Object_containsRel_ff02200000000000000f          , _instance_of_Documentation_017b35893bb2b525d9dc   );
db.assign(_instance_of_Runnable_Input____s1_01717c85b4b1db6dd737, _Object_containsRel_ff02200000000000000f          , _instance_of_Documentation_017b35893fcf512966aa   );
db.assign(_instance_of_Runnable_Input____s2_01717c85b62789063178, _Object_containsRel_ff02200000000000000f          , _instance_of_Documentation_017b35893fd03e9b2283   );
db.assign(_instance_of_Runnable_Output____s1_localeCompare$_40_$s2$_41_$_01717c85b82ead71668c, _Object_containsRel_ff02200000000000000f          , _instance_of_Documentation_017b358942f4b3302140   );
