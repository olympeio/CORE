...
const _instance_of_Documentation_017b35893bb0d6145c70 = db.assignTag('017b35893bb0d6145c70');
const _instance_of_Documentation_017b35893fc88e96ab94 = db.assignTag('017b35893fc88e96ab94');
const _instance_of_Documentation_017b35893fcd68af5d70 = db.assignTag('017b35893fcd68af5d70');
const _instance_of_Documentation_017b358942f31d6322d4 = db.assignTag('017b358942f31d6322d4');
...
db.newInstance(_instance_of_Runnable_Output____output_016cb933f367c3d1db7d)
    ...
    .done();
// :_instance_of_Documentation_017b35893bb0d6145c70
db.newInstance(_instance_of_Documentation_017b35893bb0d6145c70)
    ...
    .done();
// :_instance_of_Documentation_017b35893fc88e96ab94
db.newInstance(_instance_of_Documentation_017b35893fc88e96ab94)
    .setModelTag(_Documentation_01703376c4a81c0e9d90) // tag of the model
    // Tag of goos
    .addToGroupOfObjects(_instance_of_Coded_Function_model____Base64_Decoder_016cb933f367c3d1db7a)
    .setNameOrProperties({
    ...
    .done();
// :_instance_of_Documentation_017b35893fcd68af5d70
db.newInstance(_instance_of_Documentation_017b35893fcd68af5d70)
    .setModelTag(_Documentation_01703376c4a81c0e9d90) // tag of the model
    // Tag of goos
    .addToGroupOfObjects(_instance_of_Coded_Function_model____Base64_Decoder_016cb933f367c3d1db7a)
    .setNameOrProperties({
    ...
    .done();
// :_instance_of_Documentation_017b358942f31d6322d4
db.newInstance(_instance_of_Documentation_017b358942f31d6322d4)
    .setModelTag(_Documentation_01703376c4a81c0e9d90) // tag of the model
    // Tag of goos
    .addToGroupOfObjects(_instance_of_Coded_Function_model____Base64_Decoder_016cb933f367c3d1db7a)
    .setNameOrProperties({
        [_Documentation_description_01703376c4a81c0e9d92]:'Decoded string',
        'v'                                     :1
    })
    .done();
...
db.assign(_instance_of_Documentation_017b35893bb0d6145c70   , _Documentation_documentation_01703376c4a81c0e9d93 , _instance_of_Coded_Function_model____Base64_Decoder_016cb933f367c3d1db7a);
db.assign(_instance_of_Documentation_017b35893fc88e96ab94   , _Documentation_documentation_01703376c4a81c0e9d93 , _instance_of_Runnable_Input____base64_string_016cb933f367c3d1db7b);
db.assign(_instance_of_Documentation_017b35893fcd68af5d70   , _Documentation_documentation_01703376c4a81c0e9d93 , _instance_of_Runnable_Input____encoding_016cb933f367c3d1db7c);
db.assign(_instance_of_Documentation_017b358942f31d6322d4   , _Documentation_documentation_01703376c4a81c0e9d93 , _instance_of_Runnable_Output____output_016cb933f367c3d1db7d);
...
db.assign(_instance_of_Coded_Function_model____Base64_Decoder_016cb933f367c3d1db7a, _Object_containsRel_ff02200000000000000f          , _instance_of_Documentation_017b35893bb0d6145c70   );
db.assign(_instance_of_Runnable_Input____base64_string_016cb933f367c3d1db7b, _Object_containsRel_ff02200000000000000f          , _instance_of_Documentation_017b35893fc88e96ab94   );
db.assign(_instance_of_Runnable_Input____encoding_016cb933f367c3d1db7c, _Object_containsRel_ff02200000000000000f          , _instance_of_Documentation_017b35893fcd68af5d70   );
db.assign(_instance_of_Runnable_Output____output_016cb933f367c3d1db7d, _Object_containsRel_ff02200000000000000f          , _instance_of_Documentation_017b358942f31d6322d4   );
