...
const _instance_of_Documentation_017b35893b96ddfcb978 = db.assignTag('017b35893b96ddfcb978');
const _instance_of_Documentation_017b35893f9b130d3094 = db.assignTag('017b35893f9b130d3094');
const _instance_of_Documentation_017b35894292a3fc1b66 = db.assignTag('017b35894292a3fc1b66');
...
db.newInstance(_instance_of_Runnable_Output____s_trim$_40_$$_41_$_01717ca59b3c574bb74a)
    ...
    .done();
// :_instance_of_Documentation_017b35893b96ddfcb978
db.newInstance(_instance_of_Documentation_017b35893b96ddfcb978)
    .setModelTag(_Documentation_01703376c4a81c0e9d90) // tag of the model
    // Tag of goos
    .addToGroupOfObjects(_instance_of_Coded_Function_model____Trim_String_01717ca521db5a9c3c7c)
    .setNameOrProperties({
        [_Documentation_description_01703376c4a81c0e9d92]:'Removes whitespace from both ends of a string. Whitespace in this context is all the whitespace characters (space, tab, no-break space, etc.) and all the line terminator characters (LF, CR, etc.).\n\nUses the `trim` JavaScript function. See: [https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String)\n',
        [_Documentation_summary_01703376c4a81c0e9d91]:'Trims whitespace from the beginning and end of the string',
        'v'                                     :1
    })
    .done();
// :_instance_of_Documentation_017b35893f9b130d3094
db.newInstance(_instance_of_Documentation_017b35893f9b130d3094)
    .setModelTag(_Documentation_01703376c4a81c0e9d90) // tag of the model
    // Tag of goos
    .addToGroupOfObjects(_instance_of_Coded_Function_model____Trim_String_01717ca521db5a9c3c7c)
    .setNameOrProperties({
        [_Documentation_description_01703376c4a81c0e9d92]:'The string to trim.',
        'v'                                     :1
    })
    .done();
// :_instance_of_Documentation_017b35894292a3fc1b66
db.newInstance(_instance_of_Documentation_017b35894292a3fc1b66)
    .setModelTag(_Documentation_01703376c4a81c0e9d90) // tag of the model
    // Tag of goos
    .addToGroupOfObjects(_instance_of_Coded_Function_model____Trim_String_01717ca521db5a9c3c7c)
    .setNameOrProperties({
        [_Documentation_description_01703376c4a81c0e9d92]:'Trimmed string',
        'v'                                     :1
    })
    .done();
...
db.assign(_instance_of_Documentation_017b35893b96ddfcb978   , _Documentation_documentation_01703376c4a81c0e9d93 , _instance_of_Coded_Function_model____Trim_String_01717ca521db5a9c3c7c);
db.assign(_instance_of_Documentation_017b35893f9b130d3094   , _Documentation_documentation_01703376c4a81c0e9d93 , _instance_of_Runnable_Input____s_01717ca5233c48a8ec67);
db.assign(_instance_of_Documentation_017b35894292a3fc1b66   , _Documentation_documentation_01703376c4a81c0e9d93 , _instance_of_Runnable_Output____s_trim$_40_$$_41_$_01717ca59b3c574bb74a);
...
db.assign(_instance_of_Coded_Function_model____Trim_String_01717ca521db5a9c3c7c, _Object_containsRel_ff02200000000000000f          , _instance_of_Documentation_017b35893b96ddfcb978   );
db.assign(_instance_of_Runnable_Input____s_01717ca5233c48a8ec67, _Object_containsRel_ff02200000000000000f          , _instance_of_Documentation_017b35893f9b130d3094   );
db.assign(_instance_of_Runnable_Output____s_trim$_40_$$_41_$_01717ca59b3c574bb74a, _Object_containsRel_ff02200000000000000f          , _instance_of_Documentation_017b35894292a3fc1b66   );
