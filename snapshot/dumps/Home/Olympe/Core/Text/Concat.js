...
const _instance_of_Documentation_017b35893b9b4a3b28e8 = db.assignTag('017b35893b9b4a3b28e8');
const _instance_of_Documentation_017b35893f9f8f123f6e = db.assignTag('017b35893f9f8f123f6e');
const _instance_of_Documentation_017b35893f9fcdc098e9 = db.assignTag('017b35893f9fcdc098e9');
const _instance_of_Documentation_017b358942952fc9e781 = db.assignTag('017b358942952fc9e781');
...
db.newInstance(_instance_of_Runnable_Output____s1_$_43_$_s2_01626be5ba6b26eb2aa0)
    ...
    .done();
// :_instance_of_Documentation_017b35893b9b4a3b28e8
db.newInstance(_instance_of_Documentation_017b35893b9b4a3b28e8)
    ...
    .done();
// :_instance_of_Documentation_017b35893f9f8f123f6e
db.newInstance(_instance_of_Documentation_017b35893f9f8f123f6e)
    .setModelTag(_Documentation_01703376c4a81c0e9d90) // tag of the model
    // Tag of goos
    .addToGroupOfObjects(_instance_of_Coded_Function_model____Concat_01626be2f8325144b551)
    .setNameOrProperties({
        [_Documentation_description_01703376c4a81c0e9d92]:'The first string.',
        'v'                                     :1
    })
    .done();
// :_instance_of_Documentation_017b35893f9fcdc098e9
db.newInstance(_instance_of_Documentation_017b35893f9fcdc098e9)
    .setModelTag(_Documentation_01703376c4a81c0e9d90) // tag of the model
    // Tag of goos
    .addToGroupOfObjects(_instance_of_Coded_Function_model____Concat_01626be2f8325144b551)
    .setNameOrProperties({
        [_Documentation_description_01703376c4a81c0e9d92]:'The second string.',
        'v'                                     :1
    })
    .done();
// :_instance_of_Documentation_017b358942952fc9e781
db.newInstance(_instance_of_Documentation_017b358942952fc9e781)
    .setModelTag(_Documentation_01703376c4a81c0e9d90) // tag of the model
    // Tag of goos
    .addToGroupOfObjects(_instance_of_Coded_Function_model____Concat_01626be2f8325144b551)
    .setNameOrProperties({
        [_Documentation_description_01703376c4a81c0e9d92]:'The result of the concatenation of s1 and s2.',
        'v'                                     :1
    })
    .done();
...
db.assign(_instance_of_Documentation_017b35893b9b4a3b28e8   , _Documentation_documentation_01703376c4a81c0e9d93 , _instance_of_Coded_Function_model____Concat_01626be2f8325144b551);
db.assign(_instance_of_Documentation_017b35893f9f8f123f6e   , _Documentation_documentation_01703376c4a81c0e9d93 , _instance_of_Runnable_Input____s1_01626be4ad8f74117191);
db.assign(_instance_of_Documentation_017b35893f9fcdc098e9   , _Documentation_documentation_01703376c4a81c0e9d93 , _instance_of_Runnable_Input____s2_01626be5410d4bc19491);
db.assign(_instance_of_Documentation_017b358942952fc9e781   , _Documentation_documentation_01703376c4a81c0e9d93 , _instance_of_Runnable_Output____s1_$_43_$_s2_01626be5ba6b26eb2aa0);
...
db.assign(_instance_of_Coded_Function_model____Concat_01626be2f8325144b551, _Object_containsRel_ff02200000000000000f          , _instance_of_Documentation_017b35893b9b4a3b28e8   );
db.assign(_instance_of_Runnable_Input____s1_01626be4ad8f74117191, _Object_containsRel_ff02200000000000000f          , _instance_of_Documentation_017b35893f9f8f123f6e   );
db.assign(_instance_of_Runnable_Input____s2_01626be5410d4bc19491, _Object_containsRel_ff02200000000000000f          , _instance_of_Documentation_017b35893f9fcdc098e9   );
db.assign(_instance_of_Runnable_Output____s1_$_43_$_s2_01626be5ba6b26eb2aa0, _Object_containsRel_ff02200000000000000f          , _instance_of_Documentation_017b358942952fc9e781   );
