...
const _instance_of_Documentation_017b35893b9469df7ec9 = db.assignTag('017b35893b9469df7ec9');
const _instance_of_Documentation_017b35893f9a2b98c1ab = db.assignTag('017b35893f9a2b98c1ab');
const _instance_of_Documentation_017b35893f9a9d7ea540 = db.assignTag('017b35893f9a9d7ea540');
const _instance_of_Documentation_017b35894290dcb605fc = db.assignTag('017b35894290dcb605fc');
const _instance_of_Documentation_017b5b9535556bd51634 = db.assignTag('017b5b9535556bd51634');
...
db.newInstance(_instance_of_Runnable_Output____padded_string_01717ca65d2e4cdc1339)
    ...
    .done();
// :_instance_of_Documentation_017b35893b9469df7ec9
db.newInstance(_instance_of_Documentation_017b35893b9469df7ec9)
    .setModelTag(_Documentation_01703376c4a81c0e9d90) // tag of the model
    // Tag of goos
    .addToGroupOfObjects(_instance_of_Coded_Function_model____Pad_Start_of_String_01717ca5c5bc30fde055)
    .setNameOrProperties({
        [_Documentation_description_01703376c4a81c0e9d92]:'Method pads the current string with another string (multiple times, if needed) until the resulting string reaches the given length. The padding is applied from the start of the current string.\n\nUses the `padStart` JavaScript function. See: [https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String)\n',
        [_Documentation_summary_01703376c4a81c0e9d91]:'Pads the current string from the start with a given string and returns a new string of the provided length',
        'v'                                     :1
    })
    .done();
// :_instance_of_Documentation_017b35893f9a2b98c1ab
db.newInstance(_instance_of_Documentation_017b35893f9a2b98c1ab)
    .setModelTag(_Documentation_01703376c4a81c0e9d90) // tag of the model
    // Tag of goos
    .addToGroupOfObjects(_instance_of_Coded_Function_model____Pad_Start_of_String_01717ca5c5bc30fde055)
    .setNameOrProperties({
        [_Documentation_description_01703376c4a81c0e9d92]:'Output string length.',
        'v'                                     :1
    })
    .done();
// :_instance_of_Documentation_017b35893f9a9d7ea540
db.newInstance(_instance_of_Documentation_017b35893f9a9d7ea540)
    .setModelTag(_Documentation_01703376c4a81c0e9d90) // tag of the model
    // Tag of goos
    .addToGroupOfObjects(_instance_of_Coded_Function_model____Pad_Start_of_String_01717ca5c5bc30fde055)
    .setNameOrProperties({
        [_Documentation_description_01703376c4a81c0e9d92]:'String to pad.',
        'v'                                     :1
    })
    .done();
// :_instance_of_Documentation_017b35894290dcb605fc
db.newInstance(_instance_of_Documentation_017b35894290dcb605fc)
    .setModelTag(_Documentation_01703376c4a81c0e9d90) // tag of the model
    // Tag of goos
    .addToGroupOfObjects(_instance_of_Coded_Function_model____Pad_Start_of_String_01717ca5c5bc30fde055)
    .setNameOrProperties({
        [_Documentation_description_01703376c4a81c0e9d92]:'Padded string.',
        'v'                                     :1
    })
    .done();
// :_instance_of_Documentation_017b5b9535556bd51634
...
db.assign(_instance_of_Documentation_017b35893b9469df7ec9   , _Documentation_documentation_01703376c4a81c0e9d93 , _instance_of_Coded_Function_model____Pad_Start_of_String_01717ca5c5bc30fde055);
db.assign(_instance_of_Documentation_017b35893f9a2b98c1ab   , _Documentation_documentation_01703376c4a81c0e9d93 , _instance_of_Runnable_Input____length_01717ca65a0797881748);
db.assign(_instance_of_Documentation_017b35893f9a9d7ea540   , _Documentation_documentation_01703376c4a81c0e9d93 , _instance_of_Runnable_Input____s_01717ca5c81f2932427a);
db.assign(_instance_of_Documentation_017b35894290dcb605fc   , _Documentation_documentation_01703376c4a81c0e9d93 , _instance_of_Runnable_Output____padded_string_01717ca65d2e4cdc1339);
db.assign(_instance_of_Documentation_017b5b9535556bd51634   , _Documentation_documentation_01703376c4a81c0e9d93 , _instance_of_Runnable_Input____pad_string_01717ca65ba687c6eeff);
...
db.assign(_instance_of_Coded_Function_model____Pad_Start_of_String_01717ca5c5bc30fde055, _Object_containsRel_ff02200000000000000f          , _instance_of_Documentation_017b35893b9469df7ec9   );
db.assign(_instance_of_Runnable_Input____s_01717ca5c81f2932427a, _Object_containsRel_ff02200000000000000f          , _instance_of_Documentation_017b35893f9a9d7ea540   );
db.assign(_instance_of_Runnable_Input____length_01717ca65a0797881748, _Object_containsRel_ff02200000000000000f          , _instance_of_Documentation_017b35893f9a2b98c1ab   );
db.assign(_instance_of_Runnable_Input____pad_string_01717ca65ba687c6eeff, _Object_containsRel_ff02200000000000000f          , _instance_of_Documentation_017b5b9535556bd51634   );
db.assign(_instance_of_Runnable_Output____padded_string_01717ca65d2e4cdc1339, _Object_containsRel_ff02200000000000000f          , _instance_of_Documentation_017b35894290dcb605fc   );
