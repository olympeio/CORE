...
db.newInstance(_instance_of_Documentation_017b35893b8c99f96c12)
    ...
    .addToGroupOfObjects(_instance_of_Coded_Function_model____Is_Smaller_Than_01633efc7f259c4d2147)
    .setNameOrProperties({
        [_Documentation_description_01703376c4a81c0e9d92]:'Returns `true` if `a` is smaller than `b`. If `strictly` is set to false, then it returns true if `a` is smaller or',
