...
let _instance_of_Coded_Action_model____Logout_0163d0188add5a16a56d = db.assignTag('0163d0188add5a16a56d');
let _instance_of_Runnable_Input____0163d0188ade5a16a56d = db.assignTag('0163d0188ade5a16a56d'); // Control Flow
let _instance_of_Runnable_Output____0163d0188adf5a16a56d = db.assignTag('0163d0188adf5a16a56d'); // Control Flow
let _instance_of_Documentation_Function_Metadata_d0c3d0188add5a16a56d = db.assignTag('d0c3d0188add5a16a56d');

// :_instance_of_Coded_Action_model____Logout_0163d0188add5a16a56d
db.newModel(_instance_of_Coded_Action_model____Logout_0163d0188add5a16a56d, 'Logout').extends(_Function_Call_0168c6f020f2a96f0000).setModelTag(_Coded_Action_01621fb84e320000f012)
    .setProperties({
        [_Runnable_Definition_hardcoded_01692aa71f3108454479]:true,
        'v'                                     :1
    })
    .done();
db.updateInstance(_instance_of_Coded_Action_model____Logout_0163d0188add5a16a56d, {
        [db.DEFAULT+_Object_name_ff023000000000000011]:'Logout',
        'v'                                     :2
    });
...
db.newInstance(_instance_of_Runnable_Input____0163d0188ade5a16a56d)
    ...
    .done();
db.assign(_instance_of_Coded_Action_model____Logout_0163d0188add5a16a56d, _Runnable_Definition_Inputs_01621fb84e320000f00a  , _instance_of_Runnable_Input____0163d0188ade5a16a56d);
db.assign(_instance_of_Runnable_Input____0163d0188ade5a16a56d, _Runnable_IO_Type_IO_0168a431d3b9b7438424         , '01621fb84e320000cf00');
db.assign(_instance_of_Coded_Action_model____Logout_0163d0188add5a16a56d, _Object_containsRel_ff02200000000000000f          , _instance_of_Runnable_Input____0163d0188ade5a16a56d);
...
db.newInstance(_instance_of_Runnable_Output____0163d0188adf5a16a56d)
    ...
    .done();
db.assign(_instance_of_Coded_Action_model____Logout_0163d0188add5a16a56d, _Runnable_Definition_Outputs_01621fb84e320000f00b  , _instance_of_Runnable_Output____0163d0188adf5a16a56d);
db.assign(_instance_of_Runnable_Output____0163d0188adf5a16a56d, _Runnable_IO_Type_IO_0168a431d3b9b7438424         , '01621fb84e320000cf00');
db.assign(_instance_of_Coded_Action_model____Logout_0163d0188add5a16a56d, _Object_containsRel_ff02200000000000000f          , _instance_of_Runnable_Output____0163d0188adf5a16a56d);
...
db.assignOptional(_instance_of_Coded_Action_model____Logout_0163d0188add5a16a56d, _Object_gooRel_ff022000000000000003, parentFolder);
db.assignOptional(parentFolder, _Object_containsRel_ff02200000000000000f, _instance_of_Coded_Action_model____Logout_0163d0188add5a16a56d);
db.assignOptional(_instance_of_Coded_Action_model____Logout_0163d0188add5a16a56d, _GOO_parentGooRel_ff02200000000000000u, parentFolder);
db.assignOptional(parentFolder, _Folder_itemRel_016a697ef00ce7554692, _instance_of_Coded_Action_model____Logout_0163d0188add5a16a56d);                
