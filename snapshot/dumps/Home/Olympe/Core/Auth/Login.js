...
db.newInstance(_instance_of_Documentation_017b35893b80b4d3d6f4)
    ...
    .addToGroupOfObjects(_instance_of_Coded_Function_model____Login_0163d01778b931d801dd)
    .setNameOrProperties({
        [_Documentation_description_01703376c4a81c0e9d92]:'Attempts to log in a user providing its name and password. The authentication is attempted only once when the input control flow is triggered.',
