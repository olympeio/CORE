...
let _instance_of_Coded_Action_model____KeepSessionAlive_01701ad63ae58fe08b0b = db.assignTag('01701ad63ae58fe08b0b');
let _instance_of_Runnable_Input____01701ad63ae68fe08b0b = db.assignTag('01701ad63ae68fe08b0b'); // Control Flow
let _instance_of_Runnable_Output____01701ad63ae78fe08b0b = db.assignTag('01701ad63ae78fe08b0b'); // Control Flow
let _instance_of_Documentation_Function_Metadata_d0c01ad63ae58fe08b0b = db.assignTag('d0c01ad63ae58fe08b0b');

// :_instance_of_Coded_Action_model____KeepSessionAlive_01701ad63ae58fe08b0b
db.newModel(_instance_of_Coded_Action_model____KeepSessionAlive_01701ad63ae58fe08b0b, 'Keep Session Alive').extends(_Function_Call_0168c6f020f2a96f0000).setModelTag(_Coded_Action_01621fb84e320000f012)
    .setProperties({
        [_Runnable_Definition_hardcoded_01692aa71f3108454479]:true,
        'v'                                     :1
    })
    .done();
db.updateInstance(_instance_of_Coded_Action_model____KeepSessionAlive_01701ad63ae58fe08b0b, {
        [db.DEFAULT+_Object_name_ff023000000000000011]:'Keep Session Alive',
        'v'                                     :2
    });
db.setRootInstanceTag(_instance_of_Coded_Action_model____KeepSessionAlive_01701ad63ae58fe08b0b);

// :_instance_of_Runnable_Input____01701ad63ae68fe08b0b - Control Flow
db.newInstance(_instance_of_Runnable_Input____01701ad63ae68fe08b0b)
    .setModelTag(_Control_Flow_input) // tag of the model
    // Tag of goos
    .addToGroupOfObjects(_instance_of_Coded_Action_model____KeepSessionAlive_01701ad63ae58fe08b0b)
    .setNameOrProperties({
    ...
    .done();
db.assign(_instance_of_Coded_Action_model____KeepSessionAlive_01701ad63ae58fe08b0b, _Runnable_Definition_Inputs_01621fb84e320000f00a  , _instance_of_Runnable_Input____01701ad63ae68fe08b0b);
db.assign(_instance_of_Runnable_Input____01701ad63ae68fe08b0b, _Runnable_IO_Type_IO_0168a431d3b9b7438424         , '01621fb84e320000cf00');
db.assign(_instance_of_Coded_Action_model____KeepSessionAlive_01701ad63ae58fe08b0b, _Object_containsRel_ff02200000000000000f          , _instance_of_Runnable_Input____01701ad63ae68fe08b0b);

// :_instance_of_Runnable_Output____01701ad63ae78fe08b0b - Control Flow
db.newInstance(_instance_of_Runnable_Output____01701ad63ae78fe08b0b)
    ...
    .done();
db.assign(_instance_of_Coded_Action_model____KeepSessionAlive_01701ad63ae58fe08b0b, _Runnable_Definition_Outputs_01621fb84e320000f00b  , _instance_of_Runnable_Output____01701ad63ae78fe08b0b);
db.assign(_instance_of_Runnable_Output____01701ad63ae78fe08b0b, _Runnable_IO_Type_IO_0168a431d3b9b7438424         , '01621fb84e320000cf00');
db.assign(_instance_of_Coded_Action_model____KeepSessionAlive_01701ad63ae58fe08b0b, _Object_containsRel_ff02200000000000000f          , _instance_of_Runnable_Output____01701ad63ae78fe08b0b);
...
db.assignOptional(_instance_of_Coded_Action_model____KeepSessionAlive_01701ad63ae58fe08b0b, _Object_gooRel_ff022000000000000003, parentFolder);
db.assignOptional(parentFolder, _Object_containsRel_ff02200000000000000f, _instance_of_Coded_Action_model____KeepSessionAlive_01701ad63ae58fe08b0b);
db.assignOptional(_instance_of_Coded_Action_model____KeepSessionAlive_01701ad63ae58fe08b0b, _GOO_parentGooRel_ff02200000000000000u, parentFolder);
db.assignOptional(parentFolder, _Folder_itemRel_016a697ef00ce7554692, _instance_of_Coded_Action_model____KeepSessionAlive_01701ad63ae58fe08b0b);                
