...
db.newInstance(_instance_of_Documentation_017b35893b9e8d9c06c3)
    ...
    .addToGroupOfObjects(_instance_of_Coded_Function_model____Catch_Errors_016eeb5ede9f3094d8f5)
    .setNameOrProperties({
        [_Documentation_description_01703376c4a81c0e9d92]:'Catching an error from an error-flow allows you to access its details and trigger a control-flow every time an',
