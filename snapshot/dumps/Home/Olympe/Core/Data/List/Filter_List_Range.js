...
db.newInstance(_instance_of_Documentation_017b35893b5a892167f2)
    ...
    .addToGroupOfObjects(_instance_of_Coded_Function_model____Filter_List_Range_01717d5f60be1607fb43)
    .setNameOrProperties({
        [_Documentation_description_01703376c4a81c0e9d92]:'Get objects from a list in a specific range. All items with a rank going from `Start` to `End` (limits included) are',
