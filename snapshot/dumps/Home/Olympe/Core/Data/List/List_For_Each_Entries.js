...
db.newInstance(_instance_of_Documentation_017b35893b5fb715e2ec)
    ...
    .addToGroupOfObjects(_instance_of_Coded_Function_model____List_For_Each_Entries_01718897a585de88f500)
    .setNameOrProperties({
        [_Documentation_description_01703376c4a81c0e9d92]:'The brick outputs one object for each entry in the input list.\n\nFirst, get all entries existing before the execution of this function. Then, continuously outputs all new entries added to the watched list.',
