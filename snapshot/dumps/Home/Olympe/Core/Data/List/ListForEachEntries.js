...
let _instance_of_Coded_Function_model____ListForEachEntries_01718897a585de88f500 = db.assignTag('01718897a585de88f500');
let _instance_of_Runnable_Input____01718897a585de88f510 = db.assignTag('01718897a585de88f510'); // List
let _instance_of_Runnable_Output____01718897a585de88f520 = db.assignTag('01718897a585de88f520'); // Entry
let _instance_of_Documentation_Function_Metadata_d0c18897a585de88f500 = db.assignTag('d0c18897a585de88f500');

// :_instance_of_Coded_Function_model____ListForEachEntries_01718897a585de88f500
db.newModel(_instance_of_Coded_Function_model____ListForEachEntries_01718897a585de88f500, 'List For Each Entries').extends(_Function_Call_0168c6f020f2a96f0000).setModelTag(_Coded_Function_01621fb84e320000f011)
    .setProperties({
        [_Runnable_Definition_hardcoded_01692aa71f3108454479]:true,
        'v'                                     :1
    })
    .done();
db.updateInstance(_instance_of_Coded_Function_model____ListForEachEntries_01718897a585de88f500, {
        [db.DEFAULT+_Object_name_ff023000000000000011]:'List For Each Entries',
        'v'                                     :2
    });
db.setRootInstanceTag(_instance_of_Coded_Function_model____ListForEachEntries_01718897a585de88f500);

// :_instance_of_Runnable_Input____01718897a585de88f510 - List
db.newInstance(_instance_of_Runnable_Input____01718897a585de88f510)
    .setModelTag('0168a431d25001540001') // tag of the model
    // Tag of goos
    .addToGroupOfObjects(_instance_of_Coded_Function_model____ListForEachEntries_01718897a585de88f500)
    .setNameOrProperties({
    ...
    .done();
db.assign(_instance_of_Coded_Function_model____ListForEachEntries_01718897a585de88f500, _Runnable_Definition_Inputs_01621fb84e320000f00a  , _instance_of_Runnable_Input____01718897a585de88f510);
db.assign(_instance_of_Runnable_Input____01718897a585de88f510, _Runnable_IO_Type_IO_0168a431d3b9b7438424         , '01631aacd8276ea98490');
db.assign(_instance_of_Coded_Function_model____ListForEachEntries_01718897a585de88f500, _Object_containsRel_ff02200000000000000f          , _instance_of_Runnable_Input____01718897a585de88f510);

// :_instance_of_Runnable_Output____01718897a585de88f520 - Entry
db.newInstance(_instance_of_Runnable_Output____01718897a585de88f520)
    ...
    .done();
db.assign(_instance_of_Coded_Function_model____ListForEachEntries_01718897a585de88f500, _Runnable_Definition_Outputs_01621fb84e320000f00b  , _instance_of_Runnable_Output____01718897a585de88f520);
db.assign(_instance_of_Runnable_Output____01718897a585de88f520, _Runnable_IO_Type_IO_0168a431d3b9b7438424         , 'ff021000000000000001');
db.assign(_instance_of_Coded_Function_model____ListForEachEntries_01718897a585de88f500, _Object_containsRel_ff02200000000000000f          , _instance_of_Runnable_Output____01718897a585de88f520);
...
db.newInstance(_instance_of_Documentation_Function_Metadata_d0c18897a585de88f500)
    ...
    .done();
db.assign(_instance_of_Coded_Function_model____ListForEachEntries_01718897a585de88f500, _Display_Metadata_$_40_$Runtime$_41_$_documentation_01703376c4a81c0e9d93, _instance_of_Documentation_Function_Metadata_d0c18897a585de88f500);
db.assign(_instance_of_Coded_Function_model____ListForEachEntries_01718897a585de88f500, _Object_containsRel_ff02200000000000000f          , _instance_of_Documentation_Function_Metadata_d0c18897a585de88f500);
db.assign(_instance_of_Documentation_Function_Metadata_d0c18897a585de88f500, _Object_gooRel_ff022000000000000003, _instance_of_Coded_Function_model____ListForEachEntries_01718897a585de88f500);

// TODO: Assigning to a Folder. Check this!
let parentFolder = _List_0179b2685e214c57ba47; // Core/Data/List
db.assignOptional(_instance_of_Coded_Function_model____ListForEachEntries_01718897a585de88f500, _Object_gooRel_ff022000000000000003, parentFolder);
db.assignOptional(parentFolder, _Object_containsRel_ff02200000000000000f, _instance_of_Coded_Function_model____ListForEachEntries_01718897a585de88f500);
db.assignOptional(_instance_of_Coded_Function_model____ListForEachEntries_01718897a585de88f500, _GOO_parentGooRel_ff02200000000000000u, parentFolder);
db.assignOptional(parentFolder, _Folder_itemRel_016a697ef00ce7554692, _instance_of_Coded_Function_model____ListForEachEntries_01718897a585de88f500);                
