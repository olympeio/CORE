...
let _instance_of_Coded_Function_model____Get_Recursive_Related_0178265fcf5008c4d726 = db.assignTag('0178265fcf5008c4d726');
let _instance_of_Runnable_Input____Origin_017826601ee84f0ff1f9 = db.assignTag('017826601ee84f0ff1f9');
let _instance_of_Runnable_Input____Include_self_0178266037124b9bf475 = db.assignTag('0178266037124b9bf475');
let _instance_of_Runnable_Input____Relation_017826609794d340daef = db.assignTag('017826609794d340daef');
let _instance_of_Runnable_Output____List_01782660b3f85d5a5d6a = db.assignTag('01782660b3f85d5a5d6a');
...
db.newInstance(_instance_of_Runnable_Input____Origin_017826601ee84f0ff1f9)
    ...
    .done();
// :_instance_of_Runnable_Input____Include_self_0178266037124b9bf475
db.newInstance(_instance_of_Runnable_Input____Include_self_0178266037124b9bf475)
    .setModelTag(_Runnable_Input_0168a431d25001540001) // tag of the model
    // Tag of goos
    .addToGroupOfObjects(_instance_of_Coded_Function_model____Get_Recursive_Related_0178265fcf5008c4d726)
    .setNameOrProperties({
    ...
    .done();
// :_instance_of_Runnable_Input____Relation_017826609794d340daef
db.newInstance(_instance_of_Runnable_Input____Relation_017826609794d340daef)
    .setModelTag(_Runnable_Input_0168a431d25001540001) // tag of the model
    // Tag of goos
    .addToGroupOfObjects(_instance_of_Coded_Function_model____Get_Recursive_Related_0178265fcf5008c4d726)
    .setNameOrProperties({
...
db.assign(_instance_of_Coded_Function_model____Get_Recursive_Related_0178265fcf5008c4d726, _Runnable_Definition_Inputs_01621fb84e320000f00a  , _instance_of_Runnable_Input____Include_self_0178266037124b9bf475);
db.assign(_instance_of_Coded_Function_model____Get_Recursive_Related_0178265fcf5008c4d726, _Runnable_Definition_Inputs_01621fb84e320000f00a  , _instance_of_Runnable_Input____Relation_017826609794d340daef);
...
db.assign(_instance_of_Runnable_Input____Include_self_0178266037124b9bf475, _Runnable_IO_Type_IO_0168a431d3b9b7438424         , _Relation_ff021000000000000006                    );
db.assign(_instance_of_Runnable_Input____Relation_017826609794d340daef, _Runnable_IO_Type_IO_0168a431d3b9b7438424         , _Boolean_ff021000000000000012                     );
...
db.assign(_instance_of_Coded_Function_model____Get_Recursive_Related_0178265fcf5008c4d726, _Object_containsRel_ff02200000000000000f          , _instance_of_Runnable_Input____Include_self_0178266037124b9bf475);
db.assign(_instance_of_Coded_Function_model____Get_Recursive_Related_0178265fcf5008c4d726, _Object_containsRel_ff02200000000000000f          , _instance_of_Runnable_Input____Relation_017826609794d340daef);
