...
let _instance_of_Coded_Action_model____Begin_0162f2ecd021046908f5 = db.assignTag('0162f2ecd021046908f5');
let _instance_of_Runnable_Input____0162f2ecd022046908f5 = db.assignTag('0162f2ecd022046908f5'); // Control Flow
let _instance_of_Runnable_Output____0162f2ecd023046908f5 = db.assignTag('0162f2ecd023046908f5'); // Control Flow
let _instance_of_Documentation_Function_Metadata_d0c2f2ecd021046908f5 = db.assignTag('d0c2f2ecd021046908f5');

// :_instance_of_Coded_Action_model____Begin_0162f2ecd021046908f5
db.newModel(_instance_of_Coded_Action_model____Begin_0162f2ecd021046908f5, 'Begin Transaction').extends(_Function_Call_0168c6f020f2a96f0000).setModelTag(_Coded_Action_01621fb84e320000f012)
    .setProperties({
        [_Runnable_Definition_hardcoded_01692aa71f3108454479]:true,
        'v'                                     :1
    })
    .done();
db.updateInstance(_instance_of_Coded_Action_model____Begin_0162f2ecd021046908f5, {
        [db.DEFAULT+_Object_name_ff023000000000000011]:'Begin Transaction',
        'v'                                     :2
    });
db.setRootInstanceTag(_instance_of_Coded_Action_model____Begin_0162f2ecd021046908f5);

// :_instance_of_Runnable_Input____0162f2ecd022046908f5 - Control Flow
db.newInstance(_instance_of_Runnable_Input____0162f2ecd022046908f5)
    .setModelTag('016ac63229782039429f') // tag of the model
    // Tag of goos
    .addToGroupOfObjects(_instance_of_Coded_Action_model____Begin_0162f2ecd021046908f5)
    .setNameOrProperties({
    ...
    .done();
db.assign(_instance_of_Coded_Action_model____Begin_0162f2ecd021046908f5, _Runnable_Definition_Inputs_01621fb84e320000f00a  , _instance_of_Runnable_Input____0162f2ecd022046908f5);
db.assign(_instance_of_Runnable_Input____0162f2ecd022046908f5, _Runnable_IO_Type_IO_0168a431d3b9b7438424         , '01621fb84e320000cf00');
db.assign(_instance_of_Coded_Action_model____Begin_0162f2ecd021046908f5, _Object_containsRel_ff02200000000000000f          , _instance_of_Runnable_Input____0162f2ecd022046908f5);

// :_instance_of_Runnable_Output____0162f2ecd023046908f5 - Control Flow
db.newInstance(_instance_of_Runnable_Output____0162f2ecd023046908f5)
    ...
    .done();
db.assign(_instance_of_Coded_Action_model____Begin_0162f2ecd021046908f5, _Runnable_Definition_Outputs_01621fb84e320000f00b  , _instance_of_Runnable_Output____0162f2ecd023046908f5);
db.assign(_instance_of_Runnable_Output____0162f2ecd023046908f5, _Runnable_IO_Type_IO_0168a431d3b9b7438424         , '01621fb84e320000cf00');
db.assign(_instance_of_Coded_Action_model____Begin_0162f2ecd021046908f5, _Object_containsRel_ff02200000000000000f          , _instance_of_Runnable_Output____0162f2ecd023046908f5);

// TODO: Assigning to a Folder. Check this!
let parentFolder = _Transaction_0179b26880c1af51a32b; // Core/Data/Transaction
db.assignOptional(_instance_of_Coded_Action_model____Begin_0162f2ecd021046908f5, _Object_gooRel_ff022000000000000003, parentFolder);
db.assignOptional(parentFolder, _Object_containsRel_ff02200000000000000f, _instance_of_Coded_Action_model____Begin_0162f2ecd021046908f5);
db.assignOptional(_instance_of_Coded_Action_model____Begin_0162f2ecd021046908f5, _GOO_parentGooRel_ff02200000000000000u, parentFolder);
db.assignOptional(parentFolder, _Folder_itemRel_016a697ef00ce7554692, _instance_of_Coded_Action_model____Begin_0162f2ecd021046908f5);
