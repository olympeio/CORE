...
let _instance_of_Coded_Action_model____EndTransaction_0162f2ed1d1ba6349600 = db.assignTag('0162f2ed1d1ba6349600');
let _instance_of_Runnable_Input____0162f2ed1d1ca6349600 = db.assignTag('0162f2ed1d1ca6349600'); // Control Flow
let _instance_of_Runnable_Output____0162f2ed1d1ba6349601 = db.assignTag('0162f2ed1d1ba6349601'); // Error Flow
let _instance_of_Runnable_Output____0162f2ed1d1da6349600 = db.assignTag('0162f2ed1d1da6349600'); // Control Flow
let _instance_of_Documentation_Function_Metadata_d0c2f2ed1d1ba6349600 = db.assignTag('d0c2f2ed1d1ba6349600');

// :_instance_of_Coded_Action_model____EndTransaction_0162f2ed1d1ba6349600
db.newModel(_instance_of_Coded_Action_model____EndTransaction_0162f2ed1d1ba6349600, 'EndTransaction').extends(_Function_Call_0168c6f020f2a96f0000).setModelTag(_Coded_Action_01621fb84e320000f012)
    .setProperties({
...
// :_instance_of_Runnable_Input____0162f2ed1d1ca6349600 - Control Flow
db.newInstance(_instance_of_Runnable_Input____0162f2ed1d1ca6349600)
    ...
    .done();
db.assign(_instance_of_Coded_Action_model____EndTransaction_0162f2ed1d1ba6349600, _Runnable_Definition_Inputs_01621fb84e320000f00a  , _instance_of_Runnable_Input____0162f2ed1d1ca6349600);
db.assign(_instance_of_Runnable_Input____0162f2ed1d1ca6349600, _Runnable_IO_Type_IO_0168a431d3b9b7438424         , '01621fb84e320000cf00');
db.assign(_instance_of_Coded_Action_model____EndTransaction_0162f2ed1d1ba6349600, _Object_containsRel_ff02200000000000000f          , _instance_of_Runnable_Input____0162f2ed1d1ca6349600);

// :_instance_of_Runnable_Output____0162f2ed1d1ba6349601 - Error Flow
db.newInstance(_instance_of_Runnable_Output____0162f2ed1d1ba6349601)
    ...
    .done();
db.assign(_instance_of_Coded_Action_model____EndTransaction_0162f2ed1d1ba6349600, _Runnable_Definition_Outputs_01621fb84e320000f00b  , _instance_of_Runnable_Output____0162f2ed1d1ba6349601);
db.assign(_instance_of_Runnable_Output____0162f2ed1d1ba6349601, _Runnable_IO_Type_IO_0168a431d3b9b7438424         , '016eeb5ede9f3094d8f0');
db.assign(_instance_of_Coded_Action_model____EndTransaction_0162f2ed1d1ba6349600, _Object_containsRel_ff02200000000000000f          , _instance_of_Runnable_Output____0162f2ed1d1ba6349601);

// :_instance_of_Runnable_Output____0162f2ed1d1da6349600 - Control Flow
db.newInstance(_instance_of_Runnable_Output____0162f2ed1d1da6349600)
    ...
    .done();
db.assign(_instance_of_Coded_Action_model____EndTransaction_0162f2ed1d1ba6349600, _Runnable_Definition_Outputs_01621fb84e320000f00b  , _instance_of_Runnable_Output____0162f2ed1d1da6349600);
db.assign(_instance_of_Runnable_Output____0162f2ed1d1da6349600, _Runnable_IO_Type_IO_0168a431d3b9b7438424         , '01621fb84e320000cf00');
db.assign(_instance_of_Coded_Action_model____EndTransaction_0162f2ed1d1ba6349600, _Object_containsRel_ff02200000000000000f          , _instance_of_Runnable_Output____0162f2ed1d1da6349600);
...
db.assign(_instance_of_Documentation_Function_Metadata_d0c2f2ed1d1ba6349600, _Object_gooRel_ff022000000000000003, _instance_of_Coded_Action_model____EndTransaction_0162f2ed1d1ba6349600);

let parentFolder = _Transaction_0179b26880c1af51a32b; // Core/Data/Transaction
db.assignOptional(_instance_of_Coded_Action_model____EndTransaction_0162f2ed1d1ba6349600, _Object_gooRel_ff022000000000000003, parentFolder);
db.assignOptional(parentFolder, _Object_containsRel_ff02200000000000000f, _instance_of_Coded_Action_model____EndTransaction_0162f2ed1d1ba6349600);
db.assignOptional(_instance_of_Coded_Action_model____EndTransaction_0162f2ed1d1ba6349600, _GOO_parentGooRel_ff02200000000000000u, parentFolder);
db.assignOptional(parentFolder, _Folder_itemRel_016a697ef00ce7554692, _instance_of_Coded_Action_model____EndTransaction_0162f2ed1d1ba6349600);
