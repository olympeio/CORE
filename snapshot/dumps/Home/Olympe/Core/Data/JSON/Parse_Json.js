...
db.newInstance(_instance_of_Documentation_017b35893b73ed20429e)
    ...
    .addToGroupOfObjects(_instance_of_Coded_Function_model____Parse_Json_0162e331fae562c33ef7)
    .setNameOrProperties({
        [_Documentation_description_01703376c4a81c0e9d92]:'Parses a JSON string and extract the object specified by the path.',
...
db.newInstance(_instance_of_Documentation_017b35893f715803831d)
    ...
    .addToGroupOfObjects(_instance_of_Coded_Function_model____Parse_Json_0162e331fae562c33ef7)
    .setNameOrProperties({
        [_Documentation_description_01703376c4a81c0e9d92]:'The path',
        'v'                                     :1
    })
    .done();
