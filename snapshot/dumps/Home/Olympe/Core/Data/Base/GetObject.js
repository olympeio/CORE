...
let _instance_of_Coded_Function_model____GetObject_016324f5cf507031f6a3 = db.assignTag('016324f5cf507031f6a3');
let _instance_of_Runnable_Input____016324f5d04f06a4860a = db.assignTag('016324f5d04f06a4860a'); // Tag
let _instance_of_Runnable_Output____016324f5d1306af8afa0 = db.assignTag('016324f5d1306af8afa0'); // Object
let _instance_of_Documentation_Function_Metadata_d0c324f5cf507031f6a3 = db.assignTag('d0c324f5cf507031f6a3');

// :_instance_of_Coded_Function_model____GetObject_016324f5cf507031f6a3
db.newModel(_instance_of_Coded_Function_model____GetObject_016324f5cf507031f6a3, 'Get Object').extends(_Function_Call_0168c6f020f2a96f0000).setModelTag(_Coded_Function_01621fb84e320000f011)
    .setProperties({
        [_Runnable_Definition_hardcoded_01692aa71f3108454479]:true,
        'v'                                     :1
    })
    .done();
db.updateInstance(_instance_of_Coded_Function_model____GetObject_016324f5cf507031f6a3, {
        [db.DEFAULT+_Object_name_ff023000000000000011]:'Get Object',
        'v'                                     :2
    });
db.setRootInstanceTag(_instance_of_Coded_Function_model____GetObject_016324f5cf507031f6a3);

// :_instance_of_Runnable_Input____016324f5d04f06a4860a - Tag
db.newInstance(_instance_of_Runnable_Input____016324f5d04f06a4860a)
    .setModelTag('0168a431d25001540001') // tag of the model
    // Tag of goos
    .addToGroupOfObjects(_instance_of_Coded_Function_model____GetObject_016324f5cf507031f6a3)
    .setNameOrProperties({
    ...
    .done();
db.assign(_instance_of_Coded_Function_model____GetObject_016324f5cf507031f6a3, _Runnable_Definition_Inputs_01621fb84e320000f00a  , _instance_of_Runnable_Input____016324f5d04f06a4860a);
db.assign(_instance_of_Runnable_Input____016324f5d04f06a4860a, _Runnable_IO_Type_IO_0168a431d3b9b7438424         , 'ff021000000000000011');
db.assign(_instance_of_Coded_Function_model____GetObject_016324f5cf507031f6a3, _Object_containsRel_ff02200000000000000f          , _instance_of_Runnable_Input____016324f5d04f06a4860a);

// :_instance_of_Runnable_Output____016324f5d1306af8afa0 - Object
db.newInstance(_instance_of_Runnable_Output____016324f5d1306af8afa0)
    ...
    .done();
db.assign(_instance_of_Coded_Function_model____GetObject_016324f5cf507031f6a3, _Runnable_Definition_Outputs_01621fb84e320000f00b  , _instance_of_Runnable_Output____016324f5d1306af8afa0);
db.assign(_instance_of_Runnable_Output____016324f5d1306af8afa0, _Runnable_IO_Type_IO_0168a431d3b9b7438424         , 'ff021000000000000001');
db.assign(_instance_of_Coded_Function_model____GetObject_016324f5cf507031f6a3, _Object_containsRel_ff02200000000000000f          , _instance_of_Runnable_Output____016324f5d1306af8afa0);
...
db.newInstance(_instance_of_Documentation_Function_Metadata_d0c324f5cf507031f6a3)
    ...
    .done();
db.assign(_instance_of_Coded_Function_model____GetObject_016324f5cf507031f6a3, _Display_Metadata_$_40_$Runtime$_41_$_documentation_01703376c4a81c0e9d93, _instance_of_Documentation_Function_Metadata_d0c324f5cf507031f6a3);
db.assign(_instance_of_Coded_Function_model____GetObject_016324f5cf507031f6a3, _Object_containsRel_ff02200000000000000f          , _instance_of_Documentation_Function_Metadata_d0c324f5cf507031f6a3);
db.assign(_instance_of_Documentation_Function_Metadata_d0c324f5cf507031f6a3, _Object_gooRel_ff022000000000000003, _instance_of_Coded_Function_model____GetObject_016324f5cf507031f6a3);

// TODO: Assigning to a Folder. Check this!
let parentFolder = _DataBase_0179b26837d01a7c3cdc; // Core/Data/Base
db.assignOptional(_instance_of_Coded_Function_model____GetObject_016324f5cf507031f6a3, _Object_gooRel_ff022000000000000003, parentFolder);
db.assignOptional(parentFolder, _Object_containsRel_ff02200000000000000f, _instance_of_Coded_Function_model____GetObject_016324f5cf507031f6a3);
db.assignOptional(_instance_of_Coded_Function_model____GetObject_016324f5cf507031f6a3, _GOO_parentGooRel_ff02200000000000000u, parentFolder);
db.assignOptional(parentFolder, _Folder_itemRel_016a697ef00ce7554692, _instance_of_Coded_Function_model____GetObject_016324f5cf507031f6a3);                
