...
db.newInstance(_instance_of_Documentation_017b35893b39c55eedb4)
    ...
    .addToGroupOfObjects(_instance_of_Coded_Function_model____Create_Local_Object_016778ac951d2b536b23)
    .setNameOrProperties({
        [_Documentation_description_01703376c4a81c0e9d92]:'Creates an instance of the specified model. It is said to be `local` because it is not yet persisted in the main',
