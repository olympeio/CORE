...
let _instance_of_Coded_Function_model____CreateLocalObject_016778ac951d2b536b23 = db.assignTag('016778ac951d2b536b23');
let _instance_of_Runnable_Input____016778b236638293bbc2 = db.assignTag('016778b236638293bbc2'); // model
let _instance_of_Runnable_Output____016778ac9e05c7adc095 = db.assignTag('016778ac9e05c7adc095'); // object
let _instance_of_Documentation_Function_Metadata_d0c778ac951d2b536b23 = db.assignTag('d0c778ac951d2b536b23');

// :_instance_of_Coded_Function_model____CreateLocalObject_016778ac951d2b536b23
db.newModel(_instance_of_Coded_Function_model____CreateLocalObject_016778ac951d2b536b23, 'Create Local Object').extends(_Function_Call_0168c6f020f2a96f0000).setModelTag(_Coded_Function_01621fb84e320000f011)
    .setProperties({
        [_Runnable_Definition_hardcoded_01692aa71f3108454479]:true,
        'v'                                     :1
    })
    .done();
db.updateInstance(_instance_of_Coded_Function_model____CreateLocalObject_016778ac951d2b536b23, {
        [db.DEFAULT+_Object_name_ff023000000000000011]:'Create Local Object',
        'v'                                     :2
    });
db.setRootInstanceTag(_instance_of_Coded_Function_model____CreateLocalObject_016778ac951d2b536b23);

// :_instance_of_Runnable_Input____016778b236638293bbc2 - model
db.newInstance(_instance_of_Runnable_Input____016778b236638293bbc2)
    .setModelTag('0168a431d25001540001') // tag of the model
    // Tag of goos
    .addToGroupOfObjects(_instance_of_Coded_Function_model____CreateLocalObject_016778ac951d2b536b23)
    .setNameOrProperties({
    ...
    .done();
db.assign(_instance_of_Coded_Function_model____CreateLocalObject_016778ac951d2b536b23, _Runnable_Definition_Inputs_01621fb84e320000f00a  , _instance_of_Runnable_Input____016778b236638293bbc2);
db.assign(_instance_of_Runnable_Input____016778b236638293bbc2, _Runnable_IO_Type_IO_0168a431d3b9b7438424         , '0162f672366be5ca7a86');
db.assign(_instance_of_Coded_Function_model____CreateLocalObject_016778ac951d2b536b23, _Object_containsRel_ff02200000000000000f          , _instance_of_Runnable_Input____016778b236638293bbc2);

// :_instance_of_Runnable_Output____016778ac9e05c7adc095 - object
db.newInstance(_instance_of_Runnable_Output____016778ac9e05c7adc095)
    ...
    .done();
db.assign(_instance_of_Coded_Function_model____CreateLocalObject_016778ac951d2b536b23, _Runnable_Definition_Outputs_01621fb84e320000f00b  , _instance_of_Runnable_Output____016778ac9e05c7adc095);
db.assign(_instance_of_Runnable_Output____016778ac9e05c7adc095, _Runnable_IO_Type_IO_0168a431d3b9b7438424         , 'ff021000000000000001');
db.assign(_instance_of_Coded_Function_model____CreateLocalObject_016778ac951d2b536b23, _Object_containsRel_ff02200000000000000f          , _instance_of_Runnable_Output____016778ac9e05c7adc095);
...
db.newInstance(_instance_of_Documentation_Function_Metadata_d0c778ac951d2b536b23)
    ...
    .done();
db.assign(_instance_of_Coded_Function_model____CreateLocalObject_016778ac951d2b536b23, _Display_Metadata_$_40_$Runtime$_41_$_documentation_01703376c4a81c0e9d93, _instance_of_Documentation_Function_Metadata_d0c778ac951d2b536b23);
db.assign(_instance_of_Coded_Function_model____CreateLocalObject_016778ac951d2b536b23, _Object_containsRel_ff02200000000000000f          , _instance_of_Documentation_Function_Metadata_d0c778ac951d2b536b23);
db.assign(_instance_of_Documentation_Function_Metadata_d0c778ac951d2b536b23, _Object_gooRel_ff022000000000000003, _instance_of_Coded_Function_model____CreateLocalObject_016778ac951d2b536b23);

// TODO: Assigning to a Folder. Check this!
let parentFolder = _Operation_0179b268740d49b2a89d; // Core/Data/Operation
db.assignOptional(_instance_of_Coded_Function_model____CreateLocalObject_016778ac951d2b536b23, _Object_gooRel_ff022000000000000003, parentFolder);
db.assignOptional(parentFolder, _Object_containsRel_ff02200000000000000f, _instance_of_Coded_Function_model____CreateLocalObject_016778ac951d2b536b23);
db.assignOptional(_instance_of_Coded_Function_model____CreateLocalObject_016778ac951d2b536b23, _GOO_parentGooRel_ff02200000000000000u, parentFolder);
db.assignOptional(parentFolder, _Folder_itemRel_016a697ef00ce7554692, _instance_of_Coded_Function_model____CreateLocalObject_016778ac951d2b536b23);                
